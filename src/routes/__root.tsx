...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Sistema para facilidade de inventário da equipe de J.assy da melhor logística" },
      { property: "og:title", content: "Inventário J.assy" },
      { property: "og:description", content: "Sistema para facilidade de inventário da equipe de J.assy da melhor logística" },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "Inventário J.assy" },
      { name: "twitter:description", content: "Sistema para facilidade de inventário da equipe de J.assy da melhor logística" },
